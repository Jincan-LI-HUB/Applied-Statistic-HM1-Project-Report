\begin{tabular}{lll}
\toprule
rq\_id & question & primary\_module \\
\midrule
...
RQ4 & RQ4: How well does gdp\_country predict finalWorth in a simple regression, and are results stable under log, multivariate controls, and robust SE? & M7 \\
